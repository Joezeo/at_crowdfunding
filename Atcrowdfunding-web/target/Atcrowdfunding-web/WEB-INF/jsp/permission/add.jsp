...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form role="form">
            ...
            <button id="permission-add-submit" type="button" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> 新增</button>
            <button id="permission-add-refresh" type="button" class="btn btn-danger"><i class="glyphicon glyphicon-refresh"></i> 重置</button>
            </div>
        </form>
    </div>
</div>
<script src="${APP_PATH}/js/permission/add.js"></script>
</body>
</html>
